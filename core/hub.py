...
def build_system_prompt(mask: dict, memory_context: str, carnet_notes: list = None, presence_note: str = '', last_dominant: str = '', user_name: str = '', biblio_context: str = '', force_mem: bool = False, recent_messages: list = None, location: str = '', session_bilans: list = None, doc_context: str = '', doc_fil: str = '', doc_fil_titre: str = '') -> str:
    ...
    parts.append(
        ...
        "NE POSE JAMAIS cette question en texte libre : passe TOUJOURS par "
        "demander_precision(). Ce n'est pas une formalité. L'utilisateur lit avec une "
        "synthèse vocale et une plage braille : l'outil rend une question courte, avec des "
        "options numérotées auxquelles un chiffre suffit à répondre, là où un paragraphe "
        "rédigé l'oblige à tout réécouter pour retrouver ce qu'on lui demande. Une question "
        "posée en prose est une réponse ratée, même quand elle est pertinente.\n"
        "Et ne demande pas ce que tu peux VÉRIFIER toi-même : si un chemin de fichier ou de "
        "dossier est donné et que tu doutes de son existence ou de son contenu, va regarder "
        "(list_files) avant toute question. On ne demande à l'utilisateur que ce qui est "
