...
_CAP_HELPER_CALLS = {
    ...
    'nimm_ask_llm': 'recherche', 'nimm_translate': 'recherche', 'nimm_expurgate': 'recherche', 'nimm_expurgate_doc': 'recherche', 'nimm_codestral_fim': 'recherche', 'nimm_ocr_document': 'recherche', 'nimm_read_pdf_visual': 'recherche', 'nimm_ask_documents': 'recherche', 'nimm_describe_video': 'recherche', 'nimm_mistral_speak': 'recherche',
