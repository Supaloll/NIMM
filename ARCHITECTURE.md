...
**Reste à faire** — Étape D outils web/GitHub (suivent le patron localhost de `nimm_generate_image`, conditionnés à un cadrage sécurité de la route sortante — risque SSRF).
