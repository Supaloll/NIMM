...
def extract_all_tags(text: str) -> tuple:
    ...
    Format MEM (8 champs) : %%MEM:type|sujet|predicat|objet|contexte|memoire_type|profondeur|type_temporal%%
    Format MEM (7 champs) : %%MEM:type|sujet|predicat|objet|memoire_type|profondeur|type_temporal%%
