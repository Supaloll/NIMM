...
- 🎙️ **Conversation Live** — parle à NIMM et **coupe-le quand tu veux**, comme dans un vrai dialogue. Deux moteurs : Gemini Live (audio direct, une seconde de latence, interruption immédiate) ou Whisper + ton LLM + la voix de NIMM (plus lent, mais sans clé Gemini). **Tout est transcrit des deux côtés**, dans un champ copiable et lisible au braille — et rien n'est lu à voix haute par-dessus NIMM. Rien n'est enregistré : à la fin, tu décides de garder la transcription ou pas
